    ...
    return (
        <div className="grid grid-cols-1  mt-48 sm:mt-48  h-screen">
            <div>
                ...
                <input onChange={e => setQuery(e.target.value)} className="border py-1 border-5 border-gray-800 rounded-2xl px-2 ml-2 w-full sm:w-1/3" type="search"></input>
                <button className='rounded-xl mr-2 bg-blue-600 hover:bg-blue-800 px-2 py-1'><BiSearchAlt2 className='text-2xl text-white'/></button>
                </form>
            </div>
        </div>
    )
